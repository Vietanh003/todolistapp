...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    try {
        ...
        if ("getTasks".equals(action)) {
            try {
                List<Task> tasks = taskDAO.getTasksOverview(user.getMaNguoiDung());
    ...
    try {
        ...
        response.getWriter().write("{\"error\": \"Lỗi khi lấy chi tiết công việc: " + e.getMessage() + "\"}");
            ...
            try {
                ...
                e.printStackTrace();
                throw new ServletException("Lỗi khi lấy dữ liệu", e);
            }
        }
    } catch (Exception e) {
        e.printStackTrace();
...
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    try {
        ...
        throw new ServletException("Lỗi khi thêm công việc", e);
    }
}
